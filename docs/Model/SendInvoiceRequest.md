...
**detalle** | [**\Intifact\Sdk\Model\SendInvoiceRequestDetalleInner[]**](SendInvoiceRequestDetalleInner.md) |  |
**forma_pago** | [**\Intifact\Sdk\Model\SendInvoiceRequestFormaPagoInner[]**](SendInvoiceRequestFormaPagoInner.md) |  |
**leyendas** | [**\Intifact\Sdk\Model\SendInvoiceRequestLeyendasInner[]**](SendInvoiceRequestLeyendasInner.md) |  |
**observacion** | **string** |  | [optional]
**vendedor** | **string** |  | [optional]
**pagos** | [**\Intifact\Sdk\Model\SendInvoiceRequestPagosInner[]**](SendInvoiceRequestPagosInner.md) |  | [optional]
**detraccion** | [**\Intifact\Sdk\Model\SendInvoiceRequestDetraccion**](SendInvoiceRequestDetraccion.md) |  | [optional]
**guia_remision** | [**\Intifact\Sdk\Model\SendInvoiceRequestGuiaRemisionInner[]**](SendInvoiceRequestGuiaRemisionInner.md) |  | [optional]
