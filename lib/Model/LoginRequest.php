...
class LoginRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'login_request';
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling LoginRequest., must be smaller than or equal to 255.');
        }
        if ((!preg_match("/^(?!\\.)(?!.*\\.\\.)([A-Za-z0-9_'+\\-\\.]*)[A-Za-z0-9_+-]@([A-Za-z0-9][A-Za-z0-9\\-]*\\.)+[A-Za-z]{2,}$/", ObjectSerializer::toString($email)))) {
            throw new \InvalidArgumentException("invalid value for \$email when calling LoginRequest., must conform to the pattern /^(?!\\.)(?!.*\\.\\.)([A-Za-z0-9_'+\\-\\.]*)[A-Za-z0-9_+-]@([A-Za-z0-9][A-Za-z0-9\\-]*\\.)+[A-Za-z]{2,}$/.");
        }
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) > 100)) {
            throw new \InvalidArgumentException('invalid length for $password when calling LoginRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $password when calling LoginRequest., must be bigger than or equal to 1.');
        }
