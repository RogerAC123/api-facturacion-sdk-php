...
/**
 * ApiV1DespatchTransportistaSendPostRequestVehiculosSecundariosInner Class Doc Comment
 *
 * @category Class
 * @package  Intifact\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1DespatchTransportistaSendPostRequestVehiculosSecundariosInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_despatch_transportista_send_post_request_vehiculosSecundarios_inner';
    ...
    public function setPlaca($placa)
    {
        ...
        if ((mb_strlen($placa) > 8)) {
            throw new \InvalidArgumentException('invalid length for $placa when calling ApiV1DespatchTransportistaSendPostRequestVehiculosSecundariosInner., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($placa) < 1)) {
            throw new \InvalidArgumentException('invalid length for $placa when calling ApiV1DespatchTransportistaSendPostRequestVehiculosSecundariosInner., must be bigger than or equal to 1.');
        }
    ...
    public function setTuc($tuc)
    {
        ...
        if ((mb_strlen($tuc) > 15)) {
            throw new \InvalidArgumentException('invalid length for $tuc when calling ApiV1DespatchTransportistaSendPostRequestVehiculosSecundariosInner., must be smaller than or equal to 15.');
        }
