...
/**
 * SendDespatchTransportistaRequestVehiculosSecundariosInner Class Doc Comment
 *
 * @category Class
 * @package  Intifact\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class SendDespatchTransportistaRequestVehiculosSecundariosInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'sendDespatchTransportista_request_vehiculosSecundarios_inner';
    ...
    public function setTuc($tuc)
    {
        ...
        if ((mb_strlen($tuc) > 15)) {
            throw new \InvalidArgumentException('invalid length for $tuc when calling SendDespatchTransportistaRequestVehiculosSecundariosInner., must be smaller than or equal to 15.');
        }
