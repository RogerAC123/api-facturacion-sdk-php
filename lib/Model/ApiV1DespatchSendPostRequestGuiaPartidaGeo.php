...
/**
 * ApiV1DespatchSendPostRequestGuiaPartidaGeo Class Doc Comment
 *
 * @category Class
 * @package  Intifact\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class ApiV1DespatchSendPostRequestGuiaPartidaGeo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = '_api_v1_despatch_send_post_request_guiaPartidaGeo';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['lon'] === null && !$this->isNullableSetToNull('lon')) {
            $invalidProperties[] = "'lon' is required";
        }
